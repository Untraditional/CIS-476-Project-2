...
public class HotelRooms {
    ...
    public static final double STANDARD_ROOM_MIN_BID = 80.0;
    public static final double DELUXE_ROOM_MIN_BID = 150.0;
    public static final double SUITE_ROOM_MIN_BID = 280.0;
